...
- `resources/views/email/form.antlers.html` The forms email template.
- `resources/views/email/form_owner.antlers.html` The forms email template extending the base form partial. This goes out to the site owner. The `_text.html` version contains the text template.
- `resources/views/email/form_sender.antlers.html` The forms email template extending the base form partial. This goes out to the sender of the form. The `_text.html` version contains the text template.
...
Form email texts can be customized from the Control Panel in the Form config.
